...
public class OhlcChart {
    ...
    public Ohlc getBtcUsdOhlc() throws IOException {
        return new ObjectMapper().readValue(this.getBtcUsdOhlcResponse(), Ohlc.class);
    }

    public String getEthCanOhlcResponse() throws IOException {
        String response;
        Map<String, String> input = new HashMap<>();
    ...
    public static void main (String[] args) throws IOException {
        ...
        System.out.println(ohlcChart.getBtcUsdOhlcResponse());

        Ohlc ohlc = ohlcChart.getBtcUsdOhlc();
